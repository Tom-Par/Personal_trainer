...
export default function Contact() {
  return (
    <section id="contact">
      <div> {/* <- required wrapper so the global container styles apply */}
        <h2>Book a Free 15-min Consult</h2>

        <p className="text-neutral-700">
          Tell me a bit about your goals and schedule. I’ll reply within 24 hours.
        </p>
        ...
        >
          ...
          <div className="md:col-span-2 flex items-center justify-between">
            <span className="text-sm text-neutral-600">Prefer chat? DM @Contact on Instagram.</span>
